...
enum LegalDocument: String, Identifiable {
    ...
    var body: String {
        switch self {
        case .privacy: Self.privacyBody
        case .terms: Self.termsBody
        }
    }
    ...
    What we collect
    • Account: a Firebase user id, optional Apple (or Google) sign-in, display name, and optional profile photo.
    ...
    Your choices
    • Explore as a guest (anonymous) or save the account with Apple / Google.
    ...
    • Linking Apple or Google saves your account across reinstalls. Guest mode is temporary to that install’s anonymous id.
